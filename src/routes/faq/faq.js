      ...
      <div className="question">
        ...
        <p className={openQuestion === "q6" ? "answer visible" : "answer"}>
          ...
          <p className={openQuestion === "q6" ? "answer visible" : "answer"}>
            ...
            pasión en común: la preservación del medio ambiente. De esta visión
            nace "Green Paw", un proyecto que, aunque pequeño en tamaño, es
            vasto en ambición. Green Paw no es solo un proyecto, es el resultado
            de una misión compartida. La misión de instigar un cambio positivo y
            tangible en el cuidado de nuestro entorno natural. Con esta
            plataforma, no solo buscamos concienciar sobre la importancia del
            medio ambiente, sino también brindar a cada individuo herramientas y
            conocimientos prácticos para que puedan contribuir activamente a la
            salud de la Tierra.
          </p>
        </p>
      </div>
