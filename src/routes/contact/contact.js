  ...
  return (
    <Fragment>
      ...
      <div className="contactContainer">
        <form action="https://formsubmit.co/55009e6abd1898f3c8153f681e4bba35" method="POST">
          <h1 className="intro">
            Si necesitas información que no está disponible en nuestro sitio
            web, estamos aquí para ayudarte.
          </h1>
